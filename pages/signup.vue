<template>
    <div class="signup min-h-screen  text-gray-800  px-4 py-6 flex flex-col justify-center sm:py-12">
        <div class="relative py-3 w-full max-w-[1000px] mx-auto text-center">
            <div class="relative mt-4 bg-white shadow-md rounded-xl flex items-center overflow-hidden">
                <div class="h-full min-h-full w-1/2">
                    <img class="h-[632px] object-cover w-full" src="/public/images/5.jpg" alt="">
                </div>
                <div class="py-6 px-8 text-left w-1/2">

                    <label class="block font-bold text-base uppercase">signup form</label>
                    ...
                    <div class="flexjustify-between items-baseline">
